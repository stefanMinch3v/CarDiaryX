namespace CarDiaryX.Application.Common.Constants
{
    internal static class ApplicationConstants
    {
        ...
        public static class Trips
        {
            ...
            public const string INVALID_DEPARTURE_ADDRESS_NAME = "Departure address' name must be between 2 and 100 symbols.";
            ...
            public const string INVALID_ARRIVAL_ADDRESS_NAME = "Arrival address' name must be between 2 and 100 symbols.";
